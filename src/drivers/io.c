...
#define UNUSED_CONFIG                                                                              \
    {                                                                                              \
        IO_SELECT_GPIO, IO_DIR_OUTPUT, IO_RESISTOR_ENABLED, IO_OUT_LOW                             \
    }
...
/* To extract the port and pin number from io_e we use the generic enums and then mask the last 3
 * bits to get pin number and the next 2 bits (Bit 4 and 5) to get Port number
 */
